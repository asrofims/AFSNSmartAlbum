...
console.assert(album.totalPages === 4, `Total pages should be 4, got ${album.totalPages}`);
...
console.assert(spread1.leftPage?.pageNumber === 2, `Spread 1 left page should be Page 2, got ${spread1.leftPage?.pageNumber}`);
console.assert(spread1.rightPage?.pageNumber === 3, `Spread 1 right page should be Page 3, got ${spread1.rightPage?.pageNumber}`);
...
// 2. Test Adding Interior Spreads
const spread2 = createInteriorSpread(album, mockProject, 2);
console.assert(spread2.spreadIndex === 2, 'Spread 2 index should be 2');
console.assert(spread2.leftPage?.pageNumber === 4, `Spread 2 left page should be 4, got ${spread2.leftPage?.pageNumber}`);
console.assert(spread2.rightPage?.pageNumber === 5, `Spread 2 right page should be 5, got ${spread2.rightPage?.pageNumber}`);

// 3. Test Recalculating Page Numbers
...
// 4. Test Getting All Spreads Sequential Order
...
console.assert(allSpreads[1].name === 'Spread 1 (Pages 2-3)', 'Second spread should be Spread 1');
console.assert(allSpreads[2].name === 'Spread 2 (Pages 4-5)', 'Third spread should be Spread 2');

// 5. Test Inch-based Album
...
console.log('✓ All Album Structure domain tests passed successfully!');
